...
load 4  [expr $sigma3c*$YSize/4] -[expr $sigma3c*$XSize/4] 0.0;#load applied in x and y direction
load 7  0.0					 	 -[expr $sigma3c*$XSize/2] 0.0;#load applied in y direction
load 3 -[expr $sigma3c*$YSize/4] -[expr $sigma3c*$XSize/4] 0.0;#load applied in x and y direction
load 6 -[expr $sigma3c*$YSize/2] 0.0 0.0;#load applied in x direction
load 2 -[expr $sigma3c*$YSize/4] 0.0 0.0;#load applied in x direction
