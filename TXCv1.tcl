...
eval "recorder Node -file $dir/pressure_$Analysis_case.out -time -node 6 -dof 4 vel";
eval "recorder Element -file $dir/stress_$Analysis_case.out -time  stress"; 
eval "recorder Element -file $dir/strain_$Analysis_case.out -time  strain"; 
