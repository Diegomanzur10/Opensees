...
recorder Node -file Gdisplacement.out -time  -nodeRange 1 $numTotalNode -dof  2  disp
recorder Node -file Gvelocity.out     -time  -nodeRange 1 $numTotalNode -dof  2  vel
