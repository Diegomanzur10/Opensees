...
# soil cohesion for each layer (kPa)
set Cohe(30)          0.01
set Cohe(29)          0.01
set Cohe(28)          0.01
set Cohe(27)          0.01
...
# soil rho for each layer (Ton/m3)
set ro(1)           2.20
set ro(2)           2.1
set ro(3)           2.00
set ro(4)           2.00
...
for {set k 1} {$k <= $numLayers} {incr k 1} {
nDMaterial PressureIndependMultiYield $k 2 $ro($k) $G($k) $bulk($k) $Cohe($k) $gammaPeak \
                                           $phi($k) $refPress $pressCoeff 40\
...
test        NormUnbalance 1e-2 2000 2
