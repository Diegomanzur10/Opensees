...
set numSteps 1000   ;# Number of analysis steps
...
set loadIncr 2       ;# Static shear load bias
#############################################################
...
nDMaterial PressureDependMultiYield02 1 2 $massDen $G $B  $fangle 0.15 101 0.5\
